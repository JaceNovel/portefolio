      ...
      <div className="relative mx-auto w-full max-w-7xl px-4 py-10 sm:px-6 sm:py-14">
        ...
        <div className="mt-10 grid grid-cols-1 gap-5 lg:grid-cols-12 lg:gap-6">
          <aside className="space-y-5 lg:col-span-4">
            <section className="rounded-2xl border border-cyan-300/20 bg-slate-900/80 p-6 backdrop-blur">
              <div className="flex items-center gap-3 text-cyan-200">
                <span className="grid h-10 w-10 place-items-center rounded-xl border border-cyan-300/35 bg-cyan-500/20">
                ...
                <h2 className="text-2xl font-semibold text-slate-100 sm:text-3xl">Contact Information</h2>
              </div>

              <div className="mt-6 space-y-4 text-slate-200">
                <div className="flex items-center gap-3 border-b border-slate-700/60 pb-4 text-base">
                  <span className="text-cyan-300">✉</span>
                  <span className="break-all">contact@kernelxnotrace.com</span>
                </div>
                <div className="flex items-center gap-3 border-b border-slate-700/60 pb-4 text-base">
                  <span className="text-cyan-300">☎</span>
            ...
            <section className="rounded-2xl border border-cyan-300/20 bg-slate-900/80 p-6 backdrop-blur">
              <div className="flex items-start gap-3">
                <span className="grid h-10 w-10 shrink-0 place-items-center rounded-xl border border-cyan-300/35 bg-cyan-500/20 text-cyan-200">✦</span>
              ...
              <div className="mt-6 flex items-center">
                ...
                <div className="ml-3 rounded-md border border-cyan-300/40 bg-cyan-500/20 px-3 py-1.5 text-lg font-semibold text-cyan-100">+50</div>
              </div>
            </section>
          </aside>

          <section className="rounded-2xl border border-cyan-300/25 bg-slate-900/80 p-6 backdrop-blur sm:p-7 lg:col-span-8">
            <h2 className="text-2xl font-semibold text-slate-100 sm:text-3xl">Contact Form</h2>
            <div className="mt-6">
              <ContactForm />
            </div>
          </section>
